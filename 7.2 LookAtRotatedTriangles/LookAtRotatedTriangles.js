...
function main() {
  ...
  // Получить ссылку на u_ViewMatrix и u_ModelMatrix
  var u_ViewMatrix = gl.getUniformLocation(gl.program, 'u_ViewMatrix');
  var u_ModelMatrix = gl.getUniformLocation(gl.program, 'u_ModelMatrix');
  if(!u_ViewMatrix || !u_ModelMatrix) { 
    console.log('Не удалось получить ссылка на u_viewMatrix или u_ModelMatrix');
    return;
  }
  ...
  modelMatrix.setRotate(-10, 0, 0, 1); // Вращение вокруг оси z

  // Установить матрицы вращения и отображения
